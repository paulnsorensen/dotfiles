...
model: sonnet
context: fork
allowed-tools: Write, Bash(mkdir:*), mcp__context7__resolve-library-id, mcp__context7__query-docs, mcp__tilth__*
description: >
...
| Edit existing files precisely | `tilth_edit` | Hash-anchored edits, atomic per file |
