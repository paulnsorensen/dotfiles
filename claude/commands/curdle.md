---
name: curdle
description: Execute the complete Cheddar Flow - full 6-step cheese-powered development workflow with Explore, Plan, Code, Test, Review, and Commit phases.
---
...
4. **Test** - Use roquefort-wrecker to validate with adversarial testing (invalid inputs FIRST)
5. **Review** - Use parmigiano-sentinel to enforce all engineering principles
6. **Commit** - Use manchego-chronicler to document changes with meaningful Conventional Commits
