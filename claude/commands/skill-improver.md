...
All recommendations use 4-step calibrated confidence scoring (classify, ground, context modifiers, borderline re-assessment). Only surface recommendations scoring >= 75.
