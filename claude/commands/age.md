---
name: age
description: Staff Engineer code review of recent changes. Spawns fromage-age for review against Sliced Bread architecture, engineering principles, and complexity budgets. Only reports issues >= 80% confidence.
