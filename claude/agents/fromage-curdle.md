...
design). Skill must exist at `skills/<name>/SKILL.md`.
```
...
- If the task involves UI/UX work, check `skills/` for applicable design skills and recommend one in the "Design Skill" section.
