...
```
Agent(subagent_type: "research", prompt: "Is '[task title]' something actionable or reference material? Context: [description]. Help decide if this belongs in a task list or a reference doc.")
```
