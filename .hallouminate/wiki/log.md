...
2026-07-01 · 46b3e4481b3b8020 · new-page · architecture/omp-claude-discovery-isolation.md · Captured OMP disabledProviders claude isolation and ap isolated Claude launch distinction.


2026-07-01 · 2459c1e5c8f6d56a · merged · architecture/omp-claude-discovery-isolation.md · Added oh-my-pi startup-order caveat: documented disabledProviders policy is initialized after the first Claude settings-provider scan.
...
2026-07-01 · d4653ae1a810558d · new-page · operations/omp-model-routing.md · Captured July 2026 OMP model-role routing for direct Codex plus OpenRouter variants and fallback chains.
