...
| **isolated** (closed world) | `review`, `todo`, `fe`, `spec`, `plugin`, `tui`, `oss-docs`, `skills-doctor`, `codex-code`, `codex-plan` | `isolated: true` + launch-overlay | ccp-parity closed-world launches |
