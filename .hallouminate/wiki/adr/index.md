...
- [cheese-factory-workflow](./cheese-factory-workflow.md) — ADRs — cheese-factory-workflow
- [codex-omp-harness-upgrade-001](./codex-omp-harness-upgrade-001.md) — ADR-001 — Use model-relative OMP compaction
...
- [subagent-routing-overhaul](./subagent-routing-overhaul.md) — ADRs — subagent-routing-overhaul
