...
generate_tmux_theme() {
  ...
  cat > "$out" <<TMUX_THEME
# ${SCHEME_NAME} - tmux status bar theme
# Generated by theme/generate.sh from theme/schemes/${ACTIVE}.yaml
# DO NOT EDIT - changes will be overwritten on next \`dots sync\`
...
set -g status-style "bg=#$(pal base01),fg=#$(pal base05)"

# Left: session name
set -g status-left-length 30
set -g status-left "#[bg=#$(pal base0D),fg=#$(pal base00),bold] #S #[default] "

# Right: time
set -g status-right-length 30
set -g status-right "#[fg=#$(pal base03)]%H:%M "

# Window tabs
setw -g window-status-format "#[fg=#$(pal base03)] #I:#W "
setw -g window-status-current-format "#[bg=#$(pal base02),fg=#$(pal base0A),bold] #I:#W "
setw -g window-status-separator ""

# Pane borders
set -g pane-border-style "fg=#$(pal base02)"
set -g pane-active-border-style "fg=#$(pal base0D)"

# Messages and command line
set -g message-style "bg=#$(pal base02),fg=#$(pal base05)"
set -g message-command-style "bg=#$(pal base02),fg=#$(pal base05)"

# Copy mode highlight
setw -g mode-style "bg=#$(pal base02),fg=#$(pal base0A)"
TMUX_THEME
