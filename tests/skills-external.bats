...
setup() {
    ...
    # Canonical agent-IDs file — the installer reads this source-tree map and
    # aborts loud if it's missing, so the mock tree needs it too.
    cp "$REAL_DOTFILES_DIR/agents/skill_agents.txt" \
       "$MOCK_DOTFILES/agents/skill_agents.txt"
