...
1. **Scan available skills**: Read `skills/*/SKILL.md` to find all skill names. If the skills directory does not exist in the current project, check `$DOTFILES_DIR/skills/` (the canonical source).
